...
const rangeOfLongestBalancedString = source.rangeOfLongestBalancedString;
...
function getParenthesesDiffsForCall(source, call) {
  ...
  if (args.length > 0) {
    ...
    const realEndOfArgs = rangeOfLongestBalancedString(source, startOfArgs, endOfArgs).end;
    const lastNonWhitespaceOfArgs = lastIndexOfSignificantCharacterInRange(source, startOfArgs, realEndOfArgs);
