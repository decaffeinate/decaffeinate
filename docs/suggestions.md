...
### DS203: Change `includes` calls to have a more natural evaluation order
...
### DS204: Consider reworking code to avoid use of IIFEs
...
### DS205: Consider reworking classes to avoid `initClass`
...
### DS206: Consider shorter variations of null checks
